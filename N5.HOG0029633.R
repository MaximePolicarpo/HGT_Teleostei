...
current_tree <- 
  read.tree("N5.HOG0029633/HGT_clade.cds.aln.treefile")
...
DNA_tree <- 
  ...
  xlim(0, 1) +
  geom_treescale(x=0.02, y=25, width=0.05, color='black') 
...
current_tree <- 
  read.tree("N5.HOG0029633/HGT_clade.sec.cds.aln.treefile")
...
DNA_tree <- 
  ...
  geom_text2(aes(subset = !isTip, label = label), hjust = 1.2, vjust = 1.6,size=2) +
  xlim(0, 2) +
  geom_treescale(x=0.02, y=5, width=0.2, color='black') 
