...
grep -B10 -A10 "XM_047033889" GFF3_N5_OGGs/Hypomesus_transpacificus.gff.simplified.sorted.OGG.prez.f145.clustered.tiret | sed 's/.*N5_HOG/N5.HOG/g' | sed 's/,.*//g' | grep "[A-Z]" | grep -v "N5.HOG0047987" > Hypomesus_transpacificus.synt.txt
grep -B10 -A10 "XM_047020147" GFF3_N5_OGGs/Hypomesus_transpacificus.gff.simplified.sorted.OGG.prez.f145.clustered.tiret | sed 's/.*N5_HOG/N5.HOG/g' | sed 's/,.*//g' | grep "[A-Z]" | grep -v "N5.HOG0047987" > Hypomesus_transpacificus.synt.sec.txt

grep -B10 -A10 "XM_062485952" GFF3_N5_OGGs/Osmerus_eperlanus.gff.simplified.sorted.OGG.prez.f145.clustered.tiret | sed 's/.*N5_HOG/N5.HOG/g' | sed 's/,.*//g' | grep "[A-Z]" | grep -v "N5.HOG0047987"  > Osmerus_eperlanus.synt.txt


comm -12 <(sort Hypomesus_transpacificus.synt.txt) <(sort Osmerus_eperlanus.synt.txt) | wc -l
comm -12 <(sort Hypomesus_transpacificus.synt.sec.txt) <(sort Osmerus_eperlanus.synt.txt) | wc -l
