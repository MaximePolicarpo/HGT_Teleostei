...
grep ">" N5.HOG0013514.prot | grep "XM_031565911\|XM_031565905\|XM_042707511\|Hypomesus_transpacificus\|Osmerus_eperlanus\|Engraulis_encrasicolus\|XM_062526471"  | sed 's/>//g' > curr_ID.txt
xargs samtools faidx N5.HOG0013514.prot  < curr_ID.txt > only_Clupea_Osmeriformes.prot
xargs samtools faidx N5.HOG0013514.cds  < curr_ID.txt > only_Clupea_Osmeriformes.cds

muscle5.1.linux_intel64 -align only_Clupea_Osmeriformes.prot -output only_Clupea_Osmeriformes.aln

trimal -in only_Clupea_Osmeriformes.aln -cons 100 -backtrans only_Clupea_Osmeriformes.cds -out only_Clupea_Osmeriformes.cds.aln

iqtree -s only_Clupea_Osmeriformes.cds.aln -st DNA -nt 8 -bb 1000 --redo
